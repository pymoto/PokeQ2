...
export function ForeignLanguageQuizSettingScreen({ navigation }) {
    const [questionRange, setQuestionRange] = useState('');
    const [notSelected, setNotSelected] = useState(true);
    return (
      <View style={styles.container}>
        <Text style={styles.text}>「外国語名」からポケモンを当てるクイズ</Text>
        <RNPickerSelect
          items={[
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ForeignLanguageQuiz', { questionRange })}
